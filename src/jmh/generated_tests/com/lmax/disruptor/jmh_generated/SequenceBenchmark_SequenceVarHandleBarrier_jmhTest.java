...
import com.lmax.disruptor.jmh_generated.SequenceBenchmark_jmhType;
import com.lmax.disruptor.jmh_generated.SequenceBenchmark_jmhType;
import com.lmax.disruptor.jmh_generated.SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType;
import com.lmax.disruptor.jmh_generated.SequenceBenchmark_ThreadPinningState_jmhType;
import com.lmax.disruptor.jmh_generated.SequenceBenchmark_ThreadPinningState_jmhType;
import com.lmax.disruptor.jmh_generated.SequenceBenchmark_ThreadPinningState_jmhType;
import com.lmax.disruptor.jmh_generated.SequenceBenchmark_ThreadPinningState_jmhType;
import com.lmax.disruptor.jmh_generated.SequenceBenchmark_ThreadPinningState_jmhType;
public final class SequenceBenchmark_SequenceVarHandleBarrier_jmhTest {
    ...
    public BenchmarkTaskResult SequenceVarHandleBarrier_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType l_statesequencevarhandlebarrier1_G = _jmh_tryInit_f_statesequencevarhandlebarrier1_G(control);
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_sequencebenchmark0_8.incrementValue2(l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_1));
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            incrementValue2_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_1, l_sequencebenchmark0_8);
            ...
            if (control.isLastIteration()) {
                ...
                synchronized(this.getClass()) {
                    f_statesequencevarhandlebarrier1_G_map.remove(threadParams.getGroupIndex());
                }
            }
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "SequenceVarHandleBarrier", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            control.announceWarmupReady();
            while (control.warmupShouldWait) {
                blackhole.consume(l_sequencebenchmark0_8.read1(l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_3));
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            read1_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_3, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 2) {
            ...
            control.announceWarmupReady();
            while (control.warmupShouldWait) {
                blackhole.consume(l_sequencebenchmark0_8.read2(l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_5));
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            read2_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_5, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 3) {
            ...
            control.announceWarmupReady();
            while (control.warmupShouldWait) {
                l_sequencebenchmark0_8.setValue1(l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_7);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            setValue1_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_7, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 4) {
            ...
            control.announceWarmupReady();
            while (control.warmupShouldWait) {
                l_sequencebenchmark0_8.setValue1Volatile(l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_9);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            setValue1Volatile_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_9, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void incrementValue2_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType l_statesequencevarhandlebarrier1_G, SequenceBenchmark_ThreadPinningState_jmhType l_threadpinningstate2_1, SequenceBenchmark_jmhType l_sequencebenchmark0_8) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult SequenceVarHandleBarrier_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            incrementValue2_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_1, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult((long)res.allOps, (long)res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "SequenceVarHandleBarrier", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            notifyControl.startMeasurement = true;
            read1_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_3, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 2) {
            ...
            notifyControl.startMeasurement = true;
            read2_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_5, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 3) {
            ...
            notifyControl.startMeasurement = true;
            setValue1_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_7, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 4) {
            ...
            notifyControl.startMeasurement = true;
            setValue1Volatile_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_9, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult SequenceVarHandleBarrier_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            incrementValue2_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_1, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            res.measuredOps *= opsPerInv;
            BenchmarkTaskResult results = new BenchmarkTaskResult((long)res.allOps, (long)res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "SequenceVarHandleBarrier", buffer, benchmarkParams.getTimeUnit()));
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            int opsPerInv = benchmarkParams.getOpsPerInvocation();
            SampleBuffer buffer = new SampleBuffer();
            read1_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_3, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 2) {
            ...
            int opsPerInv = benchmarkParams.getOpsPerInvocation();
            SampleBuffer buffer = new SampleBuffer();
            read2_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_5, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 3) {
            ...
            int opsPerInv = benchmarkParams.getOpsPerInvocation();
            SampleBuffer buffer = new SampleBuffer();
            setValue1_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_7, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 4) {
            ...
            int opsPerInv = benchmarkParams.getOpsPerInvocation();
            SampleBuffer buffer = new SampleBuffer();
            setValue1Volatile_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_9, l_sequencebenchmark0_8);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void incrementValue2_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType l_statesequencevarhandlebarrier1_G, SequenceBenchmark_ThreadPinningState_jmhType l_threadpinningstate2_1, SequenceBenchmark_jmhType l_sequencebenchmark0_8) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult SequenceVarHandleBarrier_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            incrementValue2_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_1, l_sequencebenchmark0_8);
            control.preTearDown();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "SequenceVarHandleBarrier", res.getTime(), benchmarkParams.getTimeUnit()));
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            read1_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_3, l_sequencebenchmark0_8);
            control.preTearDown();
        ...
        if (threadParams.getSubgroupIndex() == 2) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            read2_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_5, l_sequencebenchmark0_8);
            control.preTearDown();
        ...
        if (threadParams.getSubgroupIndex() == 3) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            setValue1_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_7, l_sequencebenchmark0_8);
            control.preTearDown();
        ...
        if (threadParams.getSubgroupIndex() == 4) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            setValue1Volatile_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_statesequencevarhandlebarrier1_G, l_threadpinningstate2_9, l_sequencebenchmark0_8);
            control.preTearDown();
    ...
    public static void incrementValue2_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType l_statesequencevarhandlebarrier1_G, SequenceBenchmark_ThreadPinningState_jmhType l_threadpinningstate2_1, SequenceBenchmark_jmhType l_sequencebenchmark0_8) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static java.util.Map<Integer, SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType> f_statesequencevarhandlebarrier1_G_map = java.util.Collections.synchronizedMap(new java.util.HashMap<Integer, SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType>());
    
    SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType _jmh_tryInit_f_statesequencevarhandlebarrier1_G(InfraControl control) throws Throwable {
        int groupIdx = threadParams.getGroupIndex();
        SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType val = f_statesequencevarhandlebarrier1_G_map.get(groupIdx);
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            try {
            if (control.isFailing) throw new FailureAssistException();
            val = f_statesequencevarhandlebarrier1_G_map.get(groupIdx);
            if (val != null) {
                return val;
            }
            val = new SequenceBenchmark_StateSequenceVarHandleBarrier_jmhType();
            val.readyTrial = true;
            f_statesequencevarhandlebarrier1_G_map.put(groupIdx, val);
            } catch (Throwable t) {
