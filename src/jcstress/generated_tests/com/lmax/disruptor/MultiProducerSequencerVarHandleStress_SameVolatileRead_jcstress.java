...
import com.lmax.disruptor.MultiProducerSequencerVarHandleStress.SameVolatileRead;
import org.openjdk.jcstress.infra.results.ZZ_Result;

public final class MultiProducerSequencerVarHandleStress_SameVolatileRead_jcstress extends Runner<ZZ_Result> {

    volatile WorkerSync workerSync;
    SameVolatileRead[] gs;
    ZZ_Result[] gr;

    public MultiProducerSequencerVarHandleStress_SameVolatileRead_jcstress(ForkedTestConfig config) {
        super(config);
    }
