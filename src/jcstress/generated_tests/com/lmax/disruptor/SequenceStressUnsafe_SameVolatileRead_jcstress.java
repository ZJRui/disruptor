...
import com.lmax.disruptor.SequenceStressUnsafe.SameVolatileRead;
import org.openjdk.jcstress.infra.results.JJ_Result;

public final class SequenceStressUnsafe_SameVolatileRead_jcstress extends Runner<JJ_Result> {

    volatile WorkerSync workerSync;
    SameVolatileRead[] gs;
    JJ_Result[] gr;

    public SequenceStressUnsafe_SameVolatileRead_jcstress(ForkedTestConfig config) {
        super(config);
    }
