...
import com.lmax.disruptor.SequenceStressVarHandle.SameVolatileRead;
import org.openjdk.jcstress.infra.results.JJ_Result;

public final class SequenceStressVarHandle_SameVolatileRead_jcstress extends Runner<JJ_Result> {

    volatile WorkerSync workerSync;
    SameVolatileRead[] gs;
    JJ_Result[] gr;

    public SequenceStressVarHandle_SameVolatileRead_jcstress(ForkedTestConfig config) {
        super(config);
    }
